...
מספר הדגים שבני מוציא מהים בכל יום מפתלג פואסון עם תוחלת λ דגים ליום.
...
כמו כן, נחקור את התפלגות המחסור היומי בדגים ונבין כמה זה עולה לנו, תחת תרחישי ביקוש שונים.
